...
create table if not exists public.profiles (
  ...
  announce_arrival boolean not null default false,
...
-- In-app notifications. Full copy also lives in notifications.sql.
...
-- Welcome posts for new members. Full copy also lives in welcome-posts.sql.
alter table public.profiles
